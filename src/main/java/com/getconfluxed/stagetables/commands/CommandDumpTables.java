...
public class CommandDumpTables extends Command {
    ...
    public void execute (MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
    	...
    	for (Entry<String, StageTable> tablesEntry : tables.entrySet()) {
    		...
    		for (WeightedEntry<StageEntry> stageEntry : tablesEntry.getValue().getEntries()) {
    	...
    	try {
			...
			ITextComponent component = new TextComponentTranslation("stagetables.info.dump");
